const char MAIN_pagelight[] PROGMEM = R"=====(
<!DOCTYPE html>
<html>
...
<tr>
                <td width="110" height="22"><font size="2" color="#FEfeef">...</font><font size="2">isik</font></td>
                <td width="110" height="22"><input type="number" name="deger9" min="0" max="200"></td>
              </tr>
