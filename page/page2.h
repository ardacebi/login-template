const char MAIN_pagephcl[] PROGMEM = R"=====(
<!DOCTYPE html>
<html>
...
<tr>
                <td width="110" height="22"><font size="2" color="#FEfeef">...</font><font size="2">Ph</font></td>
                <td width="240" height="27"><input name="deger7" type="text"  size="1" value=""></td>
              </tr>


<tr>
                <td width="110" height="22"><font size="2" color="#FEfeef">...</font><font size="2">Cl</font></td>
                <td width="240" height="27"><input name="deger8" type="text"  size="1" value=""></td>
              </tr>
